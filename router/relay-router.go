...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.FairUseLimit(), middleware.Distribute())
	{
	...
	relayV1Router.Use(middleware.FairUseLimit())
	{
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.FairUseLimit(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.FairUseLimit())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.FairUseLimit(), middleware.Distribute())
	{
