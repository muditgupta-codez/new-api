  ...
  if (variant === 'inline') {
    return (
      <Link
        ...
        className={cn(
          'text-foreground inline-flex h-8 items-center rounded-md px-1.5 transition-colors outline-none select-none',
      ...
      <SidebarMenuItem>
        ...
        >
          <img
            src={logo}
            alt={t('Logo')}
            className='h-8 w-auto max-w-full object-contain group-data-[collapsible=icon]:hidden'
          />
        </SidebarMenuButton>
      </SidebarMenuItem>
    </SidebarMenu>
