...
func SendEmailVerification(c *gin.Context) {
	...
	content := fmt.Sprintf("<p>Hello,</p>"+
		...
		"<p>The code is valid for %d minutes. If you did not request this, please ignore this email.</p>", common.SystemName, code, common.VerificationValidMinutes)
...
func SendPasswordResetEmail(c *gin.Context) {
	...
	if _, err := model.GetUniqueUserByEmail(email); err == nil {
		...
		content := fmt.Sprintf("<p>Hello,</p>"+
			...
			"<p>If the link does not work, copy and paste the following URL into your browser:<br> %s </p>"+
			"<p>The reset link is valid for %d minutes. If you did not request this, please ignore this email.</p>", common.SystemName, link, link, common.VerificationValidMinutes)
		err := common.SendEmail(subject, email, content)
		if err != nil {
